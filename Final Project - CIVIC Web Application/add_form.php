...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <h1 class="display-4 col-12 mt-4 mb-4">Event Add Form</h1>
            </div> <!-- .row -->
        </div> <!-- .container -->
        <div class="container">
            <form action="add_confirmation.php" method="POST" id="addFormBox">
                <div class="form-group row mt-4">
                    <label for="title-id" class="col-sm-3 col-form-label text-sm-right"><h4>Event Title:<span class="text-danger">*</span></h4></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="date-id" class="col-sm-3 col-form-label mt-1 text-sm-right"><h4>Date:<span class="text-danger">*</span></h4></label>
                    <div class="col-sm-9">
                        <input type="date" class="form-control mt-2" name="event_date">
                    </div> <!-- .col -->
                </div> <!-- .form-group -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 mt-2">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input mr-2" type="radio" name="category" id="inlineCheckbox3" value="0" checked>General Events
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input mr-2" type="radio" name="category" id="inlineCheckbox1" value="1">City Government
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input mr-2" type="radio" name="category" id="inlineCheckbox2" value="2">Nonprofit & Volunteering
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input mr-2" type="radio" name="category" id="inlineCheckbox4" value="3">Culture & Community
                            </label>
                        </div>
                    </div>
                </div> <!-- .form-group -->
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-9">
                        <input type="url" class="form-control" id="info-id" name="infoURL">
                    </div>
                </div> <!-- .form-group -->
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-9">
                        <input type="url" class="form-control" id="event-id" name="eventURL">
                    </div>
                </div> <!-- .form-group -->

                <div class="form-group row mt-4">
                    <label for="email-id" class="col-sm-3 col-form-label text-sm-right"><h4>Contact Email:</h4></label>
                    <div class="col-sm-9">
