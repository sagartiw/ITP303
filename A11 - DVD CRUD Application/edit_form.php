	...
	<div class="container">
		...
		<form action="edit_confirmation.php" method="POST">
				...
				<div class="col-sm-9">
					<select name="genre" id="genre-id" class="form-control">
						...
						<?php while( $row = $results_genres->fetch_assoc() ): ?>
							<!-- Add 'selected' attribute to the <option> tag that matches the genre of this song -->
            ...
            <div class="form-group row">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" id="award-id" name="award" value="<?php echo $row_dvd['award'] ?>">
				</div>
            </div> <!-- .form-group -->
            
            <div class="form-group row">
                <label for="release-date-id" class="col-sm-3 col-form-label text-sm-right">
                    Release Date:
                </label>
				<div class="col-sm-9">
			...
			<!-- Pass dvd_title_id to edit_confirmation.php as a hidden input -->
